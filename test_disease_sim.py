import pytest
import numpy as np
from phosphorylation_module import phosphorylation_constants, phosphorylation, phospo_over_time
...
def test_phospo_over_time_length_and_values(monkeypatch):
    monkeypatch.setattr('phosphorylation_module.phosphorylation_constants',
                        lambda protein, list_of_PTMs=None: (0.1, 0.05))
    monkeypatch.setattr('phosphorylation_module.phosphorylation',
